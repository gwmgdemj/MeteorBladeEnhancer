...
{
private:
	NDINPUT8::IDirectInputDevice8A *ProxyInterface;

public:
	m_IDirectInputDevice7A(IDirectInputDevice7A *aOriginal, void *temp) : ProxyInterface(reinterpret_cast<NDINPUT8::IDirectInputDevice8A*>(aOriginal))
	{
	...
	NDINPUT8::IDirectInputDevice8A *GetProxyInterface() { return ProxyInterface; }
